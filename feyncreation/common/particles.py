...
particle_dict = {
    ...
    'vm': r'$\nu_\mu$', 'vmbar': r'$\bar{\nu_\mu}$', 'vt': r'$\nu_\tau$', 'vtbar': r'$\bar{\nu_\tau}$',
    'w+': r'$W^+$', 'w-': r'$W^-$', 'z': r'$Z$', 'gamma': r'$\gamma$', 'g': r'$g$', 'h': r'$h$',
...
particle_styles = {
    ...
    # W and Z bosons
    'w+': dict(style='wiggly'), 'w-': dict(style='wiggly'), 'z': dict(style='wiggly'), 'gamma': dict(style='wiggly'),
    
    # Higgs and scalars (dashed line style)
    'h': dict(style='-', dashes=[5, 2]), 'h+': dict(style='-', dashes=[5, 2]), 'h-': dict(style='-', dashes=[5, 2]),
    'h++': dict(style='-', dashes=[5, 2]), 'h--': dict(style='-', dashes=[5, 2]),
}

# Particles that can have arrows
arrow_particles = ['q', 'qbar', 'qp', 'qbarp', 't', 'tbar', 'b', 'bbar', 'e-', 'e+', 'mu-', 'mu+', 
    'h+', 'h-', 'h++', 'h--', 'n+', 'n-', 'n++', 'n--', 'n0', 'n0bar', 've', 'vebar', 'vm', 'vmbar', 'vt', 'vtbar']
